package me.none030.mortisheads.armorequipevent;
    ...
    public final void onClick(final InventoryClickEvent event){
        ...
        if(shift){
            ...
            if(newArmorType != null){
                ...
                if(newArmorType.equals(ArmorType.HELMET) && (equipping == isEmpty(event.getWhoClicked().getInventory().getHelmet())) || newArmorType.equals(ArmorType.CHESTPLATE) && (equipping == isEmpty(event.getWhoClicked().getInventory().getChestplate())) || newArmorType.equals(ArmorType.LEGGINGS) && (equipping == isEmpty(event.getWhoClicked().getInventory().getLeggings())) || newArmorType.equals(ArmorType.BOOTS) && (equipping == isEmpty(event.getWhoClicked().getInventory().getBoots()))){
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (newArmorType != null) {
                ...
                if (newArmorType.equals(ArmorType.HELMET) && !isEmpty(event.getPlayer().getInventory().getHelmet())) {
                    oldArmor = event.getPlayer().getInventory().getHelmet();
                }
                if (newArmorType.equals(ArmorType.CHESTPLATE) && !isEmpty(event.getPlayer().getInventory().getChestplate())) {
                    oldArmor = event.getPlayer().getInventory().getChestplate();
                }
                if (newArmorType.equals(ArmorType.LEGGINGS) && !isEmpty(event.getPlayer().getInventory().getLeggings())) {
                    oldArmor = event.getPlayer().getInventory().getLeggings();
                }
                if (newArmorType.equals(ArmorType.BOOTS) && !isEmpty(event.getPlayer().getInventory().getBoots())) {
                    oldArmor = event.getPlayer().getInventory().getLeggings();
                }
                ArmorEquipEvent armorEquipEvent = new ArmorEquipEvent(event.getPlayer(), ArmorEquipEvent.EquipMethod.HOTBAR, ArmorType.matchType(event.getItem()), oldArmor, event.getItem());
                Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
                if (armorEquipEvent.isCancelled()) {
                    event.setCancelled(true);
